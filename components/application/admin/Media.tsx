...
const Media = ({ media, handleDelete, deleteType, selectedMedia, setSelectedMedia }) =>{
   ...
   return (
       <div className='border border-gray-200 dark:border-gray-800 relative 
          group rounded overflow-hidden'>
             ...
             <DropdownMenu>
                <DropdownMenuTrigger>
                   <span className='w-7 h-7 rounded-full flex items-center 
                      justify-center bg-black/50 cursor-pointer'>
          ...
          <div className='w-full h-full absolute z-10 transition-all duration-150 
             ease-in group-hover:bg-black/30'>
          </div>
          <div>
             <Image 
