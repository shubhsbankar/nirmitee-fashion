...
const ProductReview = ({ productId }) => {
    ...
    const fetchReviews = async (pageParam) => {
        const { data: getReviews } = await axios.get(`/api/review/get?productId=${productId}&page=${pageParam}`);
        ...
        <div className='shadow rounded border mb-20'>
            ...
            <div className='p-5'>
                ...
                </div>
                {
                    ...
                    <div className='my-5'>
                            <hr className='mb-5'/>
                    <h4 className='mb-3 text-xl font-semibold'>Write A Review</h4>
                    {
                        !auth ?
                            <>
                ...
                <div className='mt-10 border-t pt-5'>
                    ...
                    <div className='mt-10'>
                        ...
                        {
                            hasNextPage && 
                            <ButtonLoading text={'Load More'} type={'button'} onClick={fetchNextPage} loading={isFetching}/>
                        }
                    </div>
                </div>
