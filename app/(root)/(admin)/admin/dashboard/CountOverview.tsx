...
function CountOverview() {
  ...
  return (
    <div className='grid lg:grid-cols-4 sm:grid-cols-2 sm:gap-10 gap-5'>
        ...
        p-3 rounded-lg border shadow border-l-4 border-l-green-400 bg-white
        dark:bg-card dark:border-gray-800 dark:border-l-green-400'>
            <div>
        ...
        <div className='flex items-center justify-between
        p-3 rounded-lg border shadow border-l-4 border-l-blue-400 bg-white
        dark:bg-card dark:border-gray-800 dark:border-l-blue-400'>
            <div>
                <h4 className='font-medium text-gray-500 dark:text-gray-200'>Total Products</h4>
...
<Link href={ADMIN_CUSTOMERS_SHOW}>
        <div className='flex items-center justify-between
        p-3 rounded-lg border shadow border-l-4 border-l-yellow-400 bg-white
        dark:bg-card dark:border-gray-800 dark:border-l-yellow-400'>
            <div>
...
<Link href=''>
        <div className='flex items-center justify-between
        p-3 rounded-lg border shadow border-l-4 border-l-cyan-400 bg-white
        dark:bg-card dark:border-gray-800 dark:border-l-cyan-400'>
            <div>
