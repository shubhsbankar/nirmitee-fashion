...
/** Derive form data type from your zod schema */
type CouponForm = z.infer<typeof couponSchema>

/** Expected API response shape for create (adjust if your backend differs) */
...
const AddCoupon: React.FC = () => {
  ...
  const onSubmit = async (values: CouponForm): Promise<void> => {
    setLoading(true)
    try {
      const { data: response } = await axios.post<CreateCouponResponse>('/api/coupon/create', values)
