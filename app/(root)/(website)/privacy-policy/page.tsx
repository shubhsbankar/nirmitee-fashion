    ...
    return (
        <div>
            ...
            <div className='lg:px-40 px-5 py-20'>
                ...
                <p>
                    At Nirmitee Fashion, we are committed to protecting your privacy and ensuring that your personal information is handled in a safe and responsible manner.
                </p>
                ...
                <p className='mt-3'>
                    Thank you for trusting Nirmitee Fashion. Your privacy is important to us.
                </p>
            </div>
        </div>
    )
