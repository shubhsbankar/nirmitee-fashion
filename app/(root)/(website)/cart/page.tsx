...
const CartPage = () => {
  ...
  useEffect(() => {
    ...
    const totalMrp = cartProducts.reduce((sum, product) => sum + (product.mrp * product.qty), 0);
                ...
                <tbody>
                  {
                    cart.products.map(product => (
                      <tr key={product.variantId} className="md:table-row block border-b">
                        ...
                        <td className="md:table-cell flex justify-between md:p-3 px-3 pb-2">
                          ...
                          <div className="justify-center flex">
                            <div className='flex justify-center items-center md:h-10 h-7 border w-fit rounded-full'>
                              ...
                              <input type="text" value={product.qty} className='md:w-14 w-8 text-center boredr-none outline-offset-0' readOnly />
                        ...
                        <td className="md:table-cell flex md:p-3 px-3 pb-2 text-center justify-between">
