...
const ProductDetails = ({ product, variant, colors, sizes, reviewCount }) => {
  ...
  const selectedImage = useSelector(state => state.selectedMediaStore.selectedImage);
          ...
          <div className='mt-5'>
            ...
            <div className='mt-5'>
              ...
              <div className='flex items-center h-10 border w-fit rounded-full'>
                ...
                <input type="text" value={qty} className='w-14 text-center boredr-none outline-offset-0' readOnly />
