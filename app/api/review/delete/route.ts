...
export async function PUT(request) {
    try {
         ...
         if (deleteType === 'SD') {
             await ReviewModel.updateMany({_id : { $in : ids}}, 
        ...
        return response(true,200,deleteType === 'SD' ? "User moved to trash successfully." 
...
export async function DELETE(request) {
    ...
    try {
        ...
        return response(true,200,"User deleted permanently");
